        ...
        <div class="user-profile layout-spacing">
            <div class="widget-content widget-content-area">
                <div class="d-flex justify-content-between">
                    <h3 class="">Profile</h3>
                    <a href="{{ ($record->id == auth()->id()) ? url('admin/profile/edit') : url('admin/profile/edit/'.$record->id) }}" class="mt-2 edit-profile"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3">
                            <path d="M12 20h9"></path>
                            <path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path>
                        </svg></a>
                </div>
                <div class="text-center user-info">
                    <img src="{{ $record->avatar ?? 'https://api.adorable.io/avatars/285/' }}" alt="{{ $record->name }}" width="100%">
                    <p class="">{{ $record->name }}</p>
                </div>
                    ...
                    <div class="">
                        <ul class="contacts-block list-unstyled">
                            ...
                            <li class="contacts-block__item">
                                ...
                                </svg>{{ $record->created_at->diffForHumans() }}
                            </li>
                            <li class="contacts-block__item">
                            ...
                            <li class="contacts-block__item">
                                <a href="mailto:{{ $record->email }}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail">
