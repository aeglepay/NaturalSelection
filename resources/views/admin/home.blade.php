                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="td-content customer-name"><img src="{{ asset('img/profile-7.jpg') }}" alt="avatar">Andy King</div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="td-content customer-name"><img src="{{ asset('img/profile-4.jpg') }}" alt="avatar">Irene Collins</div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="td-content customer-name"><img src="{{ asset('img/profile-10.jpg') }}" alt="avatar">Laurie Fox</div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="td-content customer-name"><img src="{{ asset('img/profile-13.jpg') }}" alt="avatar">Luke Ivory</div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="td-content customer-name"><img src="{{ asset('img/profile-5.jpg') }}" alt="avatar">Ryan Collins</div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="td-content customer-name"><img src="{{ asset('img/profile-6.jpg') }}" alt="avatar">Nia Hillyer</div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="td-content customer-name"><img src="{{ asset('img/profile-11.jpg') }}" alt="avatar">Sonia Shaw</div>
                                </td>
                                <td>
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="td-content product-name"><img src="{{ asset('img/speaker.jpg') }}" alt="product">Speakers</div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="td-content product-name"><img src="{{ asset('img/sunglass.jpg') }}" alt="product">Sunglasses</div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="td-content product-name"><img src="{{ asset('img/watch.jpg') }}" alt="product">Watch</div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="td-content product-name"><img src="{{ asset('img/laptop.jpg') }}" alt="product">Laptop</div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="td-content product-name"><img src="{{ asset('img/camera.jpg') }}" alt="product">Camera</div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="td-content product-name"><img src="{{ asset('img/shoes.jpg') }}" alt="product">Shoes</div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="td-content product-name"><img src="{{ asset('img/headphones.jpg') }}" alt="product">Headphone</div>
                                </td>
                                <td>
