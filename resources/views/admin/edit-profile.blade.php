...
<div class="account-settings-container layout-top-spacing">
                            ...
                            <div class="row">
                                <div class="col-md-11 mx-auto">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="aboutBio" placeholder="Tell something interesting about yourself" rows="10">I'm Creative Director aand easy to use. My aim is to bring across your message and identity in the most creative way. I created web design for many famous brand companies.</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="info">
                            ...
                            <div class="row">
                                <div class="col-md-12 text-right mb-5">
                                    <button id="add-work-platforms" class="btn bg-dark">Add</button>
                                </div>
                                <div class="col-md-11 mx-auto">
                                        ...
                                        <div class="row">
                                            <div class="col-md-11 mx-auto">
                                                <div class="input-form">
                                                    ...
                                                    <button id="add-skills" class="btn bg-dark">Add</button>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                    <form id="edu-experience" class="section edu-experience">
                        <div class="info">
                            ...
                            <div class="row">
                                <div class="col-md-12 text-right mb-5">
                                    <button id="add-education" class="btn bg-dark">Add</button>
                                </div>
                                <div class="col-md-11 mx-auto">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                    <form id="work-experience" class="section work-experience">
                        <div class="info">
                            ...
                            <div class="row">
                                <div class="col-md-12 text-right mb-5">
                                    <button id="add-work-exp" class="btn bg-dark">Add</button>
                                </div>
                                <div class="col-md-11 mx-auto">
    ...
    <div class="account-settings-footer">
        ...
        <div class="as-footer-container">
            ...
            <button id="multiple-reset" class="btn bg-dark">Reset All</button>
            <div class="blockui-growl-message">
                <i class="flaticon-double-check"></i>&nbsp; Settings Saved Successfully
            </div>
            <button id="multiple-messages" class="btn bg-dark">Save Changes</button>
