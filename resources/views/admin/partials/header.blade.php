    ...
    <header class="header navbar navbar-expand-sm">
        ...
        <ul class="navbar-item theme-brand flex-row  text-center">
            <li class="nav-item theme-logo">
                <a href="{{ url('/') }}">
                    <img src="{{ asset('img/theme/favicon.png') }}" class="navbar-logo" alt="{{ config('app.name', 'Laravel') }}">
                </a>
            </li>
        ...
        <ul class="navbar-item flex-row ml-md-auto">
                    ...
                    <div class="">
                        <a class="dropdown-item">
                            <div class="">
                                ...
                                <div class="media">
                                    <div class="user-img">
                                        <img class="usr-img rounded-circle" src="{{ asset('img/profile-11.jpg') }}" alt="profile">
                                    </div>
                        ...
                        <a class="dropdown-item">
                            <div class="">
                                ...
                                <div class="media">
                                    <div class="user-img">
                                        <img class="usr-img rounded-circle" src="{{ asset('img/profile-16.jpg') }}" alt="profile">
                                    </div>
                                    <div class="media-body">
                                        <div class="">
                        ...
                        <a class="dropdown-item">
                            <div class="">
                                ...
                                <div class="media">
                                    <div class="user-img">
                                        <img class="usr-img rounded-circle" src="{{ asset('img/profile-34.jpg') }}" alt="profile">
                                    </div>
                                    <div class="media-body">
                                        <div class="">
            ...
            <li class="nav-item dropdown user-profile-dropdown">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                    <img class="rounded-circle" src="{{ user()->avatar ?? 'https://api.adorable.io/avatars/285/' }}" alt="{{ user()->name }}">
                </a>
